...
public abstract class GroupingTest {
    ...
    public static class ShardRange extends GroupingTest {
        ...
        public static void setUp() throws Exception {
            ...
            QueryTestTableHelper qtth = new QueryTestTableHelper(GroupingTest.ShardRange.class.toString(), log, false);
    ...
    public static class DocumentRange extends GroupingTest {
        ...
        public static void setUp() throws Exception {
            ...
            QueryTestTableHelper qtth = new QueryTestTableHelper(DocumentRange.class.toString(), log, false);
            connector = qtth.connector;
